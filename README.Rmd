...
You can download the compendium as a zip from from this URL: <https://github.com/jixing475/drakeBMI/archive/master.zip>

Or you can install this compendium as an R package, drakeBMI, from GitHub with:
